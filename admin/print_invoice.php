...
<body>
    ...
    <div class="invoice-container">
        ...
        <div class="footer">
            ...
            <p><small>ເອກະສານນີ້ຖືກສ້າງຂຶ້ນໂດຍລະບົບອັດຕະໂນມັດ.</small></p>
        </div>

        <!-- QR Code for Digital Copy -->
        <div class="qr-code">
            <!-- Add QR Code generation here if needed -->
            <img src="https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=<?php echo urlencode('https://yourdomain.com/verify-invoice/' . $order['order_number']); ?>" alt="QR Code">
            <p><small>ສະແກນເພື່ອເບິ່ງສະຖານະໃບບິນ</small></p>
        </div>
    </div>
</body>
